...
float: right;
font-size: 16px;"> Last access : 31 Januari 2019 &nbsp; <a href="login.html"
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li><a href="index.php?halaman=matakuliah"><i class="fa fa-dashboard fa-3x"></i> Mata Kuliah</a>
                    </li>
                    <li><a href="index.php?halaman=kelas"><i class="fa fa-dashboard fa-3x"></i>Kelas</a></li>
                    <li><a href="index.php?halaman=absensi"><i class="fa fa-dashboard fa-3x"></i>Absensi</a></li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                if (isset($_GET['halaman']))
                {
                    ...
                    else if ($_GET ['halaman']=="matakuliah")
                    {
                        include 'matkul.php' ;
                    }
