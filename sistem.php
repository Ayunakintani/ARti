...
<a-assets>  
    ...
    <a-scene embedded vr-mode-ui="enabled: false;" arjs='detectionMode: mono_and_matrix; matrixCodeType: 3x3; debugUIEnabled: false;'>
        ...
        <a-marker type='barcode' value='1'>
                ...
                <a-entity rotation ="-90 0 0" position="-3.5 -2 -1" text-geometry="value: Pemantau Jadwal Ruangan; font: #exoItalicFont; style: italic; size: 0.2; weight: bold; height: 0;" material="shader: flat; color:white"></a-entity>
